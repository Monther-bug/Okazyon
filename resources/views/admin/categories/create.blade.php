<x-layouts.admin-dashboard>
    <x-slot:title>{{ __('categories.create_title') }}</x-slot>
        <x-slot:header>{{ __('categories.create_title') }}</x-slot>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <select id="type" name="type" required
                                    ...
                                    <option value="food">{{ __('categories.type_food') }}</option>
                                    <option value="goods">{{ __('categories.type_goods') }}</option>
                                </select>
                            </div>
                        </div>
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-slate-600 dark:text-slate-400 justify-center">
                                        <label for="image"
                                            ...
                                            <span>{{ __('categories.upload_file') }}</span>
                                            <input id="image" name="image" type="file" class="sr-only" accept="image/*">
                                        </label>
                                        <p class="pl-1">{{ __('categories.drag_drop') }}</p>
                                    </div>
