    ...
    <div class="space-y-8 font-sans antialiased">
        ...
        <div class="flex items-center justify-between mb-8">
            <a href="{{ route('seller.products.index') }}"
                class="inline-flex items-center gap-2 text-gray-500 hover:text-red-600 transition-colors font-semibold">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('seller.products.edit', $product) }}"
                    class="inline-flex items-center gap-2 px-5 py-2.5 bg-red-50 text-red-600 font-bold text-sm rounded-xl shadow-sm hover:bg-red-100 hover:shadow transition-all duration-200">
                ...
                <div class="p-8 lg:pl-0 lg:pr-8 lg:py-8 flex flex-col justify-center">
                    ...
                    <div class="mb-6">
                        ...
                        @if($product->status === 'approved')
                            <span
                                class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold bg-green-100 text-green-700 border border-green-200 mb-4">
                        ...
                        <div class="flex items-center gap-2 text-sm text-gray-500 font-medium">
                            <span
                                class="bg-gray-100 px-3 py-1 rounded-lg border border-gray-200">{{ $product->category->name ?? 'Uncategorized' }}</span>
                            <span>•</span>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="prose prose-red text-gray-600 max-w-none">
